...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
          ...
          Usuario usuario = us.obterPorEmail(email); //retorna o j_username
          request.setAttribute("Usuario", usuario);
          
          String caixaEntrada = "";
          if(request.isUserInRole("empresa")) {
              
              caixaEntrada = "/empresa/index.jsp";
          } else if(request.isUserInRole("candidato")) {
              
              caixaEntrada = "/candidato/index.jsp";
          } else {
              
              caixaEntrada = "/administrador/index.jsp";
          }
